...
class SupabaseProfilesDatabaseService {
    private supabaseClient = createServerSupabaseClient()

    // Profile operations (linked to auth.users)
    ...
    async getDashboardStats() {
        const [profilesResult, patientsResult, scansResult, analysesResult] = await Promise.all([
...
export const db = new SupabaseProfilesDatabaseService()
