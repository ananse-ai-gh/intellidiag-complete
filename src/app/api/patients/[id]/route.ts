        ...
        return NextResponse.json({
            ...
            data: {
                patient: {
                    ...
                    street: (updatedPatient as any).street || updatedPatient.address || '',
                    city: (updatedPatient as any).city || '',
                    state: (updatedPatient as any).state || '',
                    zipCode: (updatedPatient as any).zip_code || '',
                    country: (updatedPatient as any).country || '',
                    assignedDoctorId: null,
                    isActive: true,
